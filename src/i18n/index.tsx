...
const en = {
  ...
  paymentInstructions: "Transfer the amount, then submit your phone number and transaction ID. Your event goes live once we confirm the payment.",
  yourPhone: "Your phone number",
  transactionRef: "Transaction ID / number",
  ivePaid: "I've paid — Submit",
  paymentFieldsRequired: "Enter your phone number and transaction ID",
  uploads: "uploads",
...
const am: Dict = {
  ...
  paymentInstructions: "ክፍያውን ያስተላልፉ፣ ከዚያ ስልክ ቁጥርዎን እና የግብይት መለያውን ያስገቡ። ክፍያው ሲረጋገጥ ዝግጅቱ ይጀምራል።",
  yourPhone: "ስልክ ቁጥርዎ",
  transactionRef: "የግብይት መለያ ቁጥር",
  ivePaid: "ከፍያለሁ — አስገባ",
  paymentFieldsRequired: "ስልክ ቁጥር እና የግብይት መለያ ያስገቡ",
  uploads: "የተጫኑ",
...
const fr: Dict = {
  ...
  paymentInstructions: "Effectuez le virement, puis indiquez votre numéro de téléphone et l'identifiant de transaction. Votre événement sera activé après confirmation.",
  yourPhone: "Votre numéro de téléphone",
  transactionRef: "Identifiant de transaction",
  ivePaid: "J'ai payé — Envoyer",
  paymentFieldsRequired: "Saisissez votre numéro et l'identifiant de transaction",
  uploads: "fichiers",
...
const es: Dict = {
  ...
  paymentInstructions: "Realiza la transferencia y luego envía tu número de teléfono y el ID de la transacción. Tu evento se activará tras la confirmación.",
  yourPhone: "Tu número de teléfono",
  transactionRef: "ID de la transacción",
  ivePaid: "He pagado — Enviar",
  paymentFieldsRequired: "Introduce tu número y el ID de la transacción",
  uploads: "archivos",
